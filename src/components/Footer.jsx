     ...
     return (
          <footer>
               <div className={styles.redes}>
                    ...
                    <a href="wa.me/5519947527361?text=Ola!+Gostaria+de+iniciar+a+requisi%C3%A7%C3%A3o+de+um+novo+projeto.+Poderia+me+informar+os+pr%C3%B3ximos+passos,+por+favor?">
